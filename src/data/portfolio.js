...
export const projects = [
  ...
  },
  {
    ...
    thumbnail: 'profiles/worldcel_profile.jpg',
    thumbnailMode: 'profile',
    description:
  ...
  {
    id: 'dan-the-man-gameplay',
    kind: 'personal',
    format: 'long',
    featured: false,
    title: 'Dan The Man | Gameplay',
    client: 'Predo',
    clientUrl: 'https://www.youtube.com/@Predin._./videos',
    profileInitials: 'P',
    profileImage: 'profiles/predo_profile.jpg',
    description:
      'Gameplay da série de vídeos do canal sobre o jogo Dan The Man.',
    software: 'Adobe Premiere Pro',
...
export const brawlShorts = brawlShortVideos.map(({ videoId }, index) => ({
  ...
  profileInitials: 'P',
  profileImage: 'profiles/predo_tiktok_profile.jpeg',
  thumbnail: 'profiles/predo_tiktok_profile.jpeg',
  thumbnailMode: 'profile',
...
export const motionEdits = editVideos.map(({ videoId, viewCount }, index) => ({
  ...
  profileInitials: 'LGF',
  profileImage: 'profiles/lgf_predo_tiktok_profile.jpeg',
  thumbnail: 'profiles/lgf_predo_tiktok_profile.jpeg',
  thumbnailMode: 'profile',
